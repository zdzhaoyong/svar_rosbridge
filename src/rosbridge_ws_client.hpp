...
public:
  ...
  void publish(const std::string& topic, const std::string& msg, const std::string& id = "")
  {
    std::string message = "\"op\":\"publish\", \"topic\":\"" + topic + "\", \"msg\":" + msg;
  ...
  void serviceResponse(const std::string& service, const std::string& id, bool result, const std::string& values = "{}")
  {
  ...
  void callService(const std::string& service, const InMessage& callback, const std::string& args = "{}", const std::string& id = "", int fragment_size = -1, const std::string& compression = "")
  {
